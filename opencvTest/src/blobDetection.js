...
function findBlobs (image, binaryImage, params) {
    ...
    for (let i = 0; i < contours.size(); i++) {
        ...
        let center, moms; if (params.faster) {
        ...
        if (params.filterByColor) {
            // console.log(binaryImage.ucharAt(Math.round(center.location.y), Math.round(center.location.x)));
            if (
...
function simpleBlobDetector (image, params) {
    //default parameters will be overwritten by params
